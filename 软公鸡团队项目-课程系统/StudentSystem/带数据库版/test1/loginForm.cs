...
namespace test1
{
    ...
    {
        //public static string connectionString = "uid=abc ;pwd=123456 ;initial catalog=student;data source=DESKTOP-6715IE8;Connect Timeout=900";
        public static string connectionString = "server=(local);integrated security=true;database=student;user id=sa;password=123";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (role == "管理员")
                {
                    ...
                    //{
                        conn.Close();
                        ManagerTreeview mainframe = new ManagerTreeview();
                ...
                else if (role == "学生")
                {
                    ...
                    //{
                        //this.Close();
                        conn.Close();
                        StudentTreeview mainframe = new StudentTreeview();
                        mainframe.BringToFront();
                        mainframe.Show();
                        this.Hide();
                    //}
               ...
               else if(role=="教师")
                {
                    ...
                    //{
                    conn.Close();
                    TeacherTreeview mainframe = new TeacherTreeview();
                    mainframe.BringToFront();
                    mainframe.Show();
                    this.Hide();
